...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->services['profiler'])) + (int) (isset($this->services['validator'])) + (int) (isset($this->privates['debug.stopwatch'])) + (int) (isset($this->privates['form.type.entity'])) + (int) (isset($this->privates['swiftmailer.email_sender.listener'])) + (int) (isset($this->services['security.token_storage']));
}), array('profiler' => 'reset', 'debug.validator' => 'reset', 'debug.stopwatch' => 'reset', 'form.type.entity' => 'reset', 'swiftmailer.email_sender.listener' => 'reset', 'security.token_storage' => 'setToken'));
