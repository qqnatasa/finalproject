...
class __TwigTemplate_9f8171207461dc2b2d76b3a13bcee7e083d4701c644451bee928a292580844a6 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        echo "
<h1>Profile <input type=\"button\" class=\"btn btn-primary\" onclick=\"document.location.href=
'";
        // line 4
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("fos_user_profile_edit");
        echo "'\"value=\"Edit Profile\"><h1>
...
<div class=\"fos_user_user_show\">
    <p>";
        ...
        echo ": ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new Twig_Error_Runtime('Variable "user" does not exist.', 7, $this->source); })()), "username", array()), "html", null, true);
        echo "</p>
    <p>";
        // line 8
...
";
    ...
    {
        return array (  45 => 8,  39 => 7,  33 => 4,  29 => 2,);
    }
...
<h1>Profile <input type=\"button\" class=\"btn btn-primary\" onclick=\"document.location.href=
'{{path('fos_user_profile_edit')}}'\"value=\"Edit Profile\"><h1>

<div class=\"fos_user_user_show\">
    <p>{{ 'profile.show.username'|trans }}: {{ user.username }}</p>
    <p>{{ 'profile.show.email'|trans }}: {{ user.email }}</p>
</div>
", "@FOSUser/Profile/show_content.html.twig", "C:\\Bitnami\\wampstack-7.1.22-0\\frameworks\\project\\templates\\bundles\\FOSUserBundle\\Profile\\show_content.html.twig");
    }
}
